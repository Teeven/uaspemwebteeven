              ...
              <form method="POST" action="{{ url('/alternatif/update/'.$alternatif->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="Reputasi" placeholder="Nilai Kriteria (Reputasi)" value="{{ $alternatif->Reputasi}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="Keandalan" class="col-sm-2 col-form-label">C3</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="Keandalan" placeholder="Nilai Kriteria (Keandalan)" value="{{ $alternatif->Keandalan}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="Kecepatan_Pelayanan" class="col-sm-2 col-form-label">C4</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="Kecepatan_Pelayanan" placeholder="Nilai Kriteria (Kecepatan Pelayanan)" value="{{ $alternatif->Kecepatan_Pelayanan}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="Biaya" class="col-sm-2 col-form-label">C5</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="Biaya" placeholder="Nilai Kriteria (Biaya)" value="{{ $alternatif->Biaya}}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
